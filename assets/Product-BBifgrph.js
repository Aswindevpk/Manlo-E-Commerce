import{u,r as p,a as w,b as E,j as e,S as q,d as i,V as x,c as b,e as A,f as S,g as F,A as W,G as R,C as _,B as K,h as P,i as M,k as y,H as C,s as U,l as G}from"./index-KJ9wKMvK.js";import{g as V,a as D,b as N,c as T,d as $,e as Q}from"./apiProduct-C23VXKK6.js";import{A as H,G as I,u as O}from"./useDeleteWishlist-DaxjpuSe.js";import{P as Y}from"./ProductItem-BTuBiTdJ.js";import{u as J}from"./useGetProducts-CYF7Jkxv.js";import{E as X}from"./EmptyState-ijO7v6Yj.js";function Z({productId:r}){const{isLoading:t,data:s,error:n}=u({queryKey:["color",r],queryFn:()=>V({productId:r}),enabled:!!r,retry:!1});return{isLoading:t,colors:s,error:n}}const ee=i.div`
  display: flex;
  gap: 2rem;
`,re=i.button`
    aspect-ratio:1/1;
