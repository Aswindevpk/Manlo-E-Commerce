import{f as r,u,b as d,j as t,h as m,C as c,R as p,B as h,d as f}from"./index-DRfNn9gb.js";import{a as x,u as j}from"./useDeleteWishlist-vkmPi0Pa.js";import{P as y}from"./ProductItem-CND2-dyE.js";import{E as g}from"./EmptyState-alGSbvmm.js";function v(){const{user:s}=r(),e=s==null?void 0:s.id,{isLoading:n,data:o,error:i}=u({queryKey:["allWishlist"],queryFn:()=>x({userId:e}),enabled:!!e});return{wishlist:o,isLoading:n,error:i}}const W=f.div`
    display: flex;
    flex-wrap:wrap;
