import{u,r as p,a as w,b as E,j as e,S as q,d as i,V as x,c as b,e as A,f as S,g as F,A as W,G as R,C as _,B as K,h as P,i as M,k as y,H as C,s as U,l as G}from"./index-DRfNn9gb.js";import{g as V,a as D,b as N,c as T,d as $,e as Q}from"./apiProduct-BmE6HX7m.js";import{A as H,G as I,u as O}from"./useDeleteWishlist-vkmPi0Pa.js";import{P as Y}from"./ProductItem-CND2-dyE.js";import{u as J}from"./useGetProducts-BPpYQT2X.js";import{E as X}from"./EmptyState-alGSbvmm.js";function Z({productId:r}){const{isLoading:t,data:s,error:n}=u({queryKey:["color",r],queryFn:()=>V({productId:r}),enabled:!!r,retry:!1});return{isLoading:t,colors:s,error:n}}const ee=i.div`
  display: flex;
  gap: 2rem;
`,re=i.button`
    aspect-ratio:1/1;
